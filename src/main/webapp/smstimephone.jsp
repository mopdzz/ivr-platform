...
<%
    ...
    //     System.out.println(spnumber);
		...
		sql=" select feecode,COUNT(DISTINCT(linkid))   from sms_mo where mobile='"+phone+"' and createDate >'"+starttime+"'  and createDate <'"+stoptime+"'  GROUP By feecode";                          
        sql2=" select b.feecode,count(*) from sms_mr a ,(select DISTINCT(linkid),feecode,mobile,createDate  from sms_mo where  createDate >'"+starttime+"'  and createDate <'"+stoptime+"') b where a.linkid = b.linkid  and  a.mobile='"+phone+"' "
        	+"and b.mobile=a.mobile and a.statestr='DELIVRD' and b.createDate >'"+starttime+"'  and b.createDate <'"+stoptime+"' GROUP BY b.feecode "; 
        sql1=" select b.feecode,count(*) from sms_mt a,(select DISTINCT(linkid),feecode,mobile,createDate from sms_mo where  createDate >'"+starttime+"'  and createDate <'"+stoptime+"') b where a.linkid = b.linkid  and  b.mobile='"+phone+"' and b.createDate >'"+starttime+"'  and b.createDate <'"+stoptime+"'  GROUP By b.feecode;";
        String hapduan=phone.substring(0,7); 
        sql3="select sheng from ivr_hd where hd='"+hapduan+"'" ;
          sql4="select a.content from sms_mt a,(select DISTINCT(linkid),feecode,mobile,createDate  from sms_mo where  createDate >'"+starttime+"'  and createDate <'"+stoptime+"') b where a.linkid = b.linkid  and  b.mobile='"+phone+"' and b.createDate >'"+starttime+"'  and b.createDate <'"+stoptime+"';";
