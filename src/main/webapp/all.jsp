...
<table width="1400" height="124" border="1" align="center">
    <td width="125">日期</td>
	  <td width="106"><%=list.get(0)%></td>
    <td width="106"><%=list.get(1)%></td>
    <td width="106"><%=list.get(2)%></td>
    <td width="106"><%=list.get(3)%></td>
    <td width="106"><%=list.get(4)%></td>
    <td width="106"><%=list.get(5)%></td>
    <td width="106"><%=list.get(6)%></td>
    <td width="106"><%=list.get(7)%></td>
    <td width="106"><%=list.get(8)%></td>
    <td width="106"><%=list.get(9)%></td>
    <td width="106"><%=list.get(10)%></td>
    <td width="106"><%=list.get(11)%></td>
    <td width="106"><%=list.get(12)%></td>
    <td width="106"><%=list.get(13)%></td>
    <td width="106"><%=list.get(14)%></td>
    <td width="106"><%=list.get(15)%></td>
    <td width="106"><%=list.get(16)%></td>
    <td width="106"><%=list.get(17)%></td>   
    <td width="106"><%=list.get(18)%></td>
    <td width="106"><%=list.get(19)%></td>
    <td width="106"><%=list.get(20)%></td>
    <td width="106"><%=list.get(21)%></td>              
    <td width="106"><%=list.get(22)%></td>
    <td width="106"><%=list.get(23)%></td>                  
    <td width="106"><%=list.get(24)%></td>              
    <td width="106"><%=list.get(25)%></td>                  
    <td width="106"><%=list.get(26)%></td>                  
    <td width="106"><%=list.get(27)%></td>                  
    <td width="106"><%=list.get(28)%></td>
    <td width="106"><%=list.get(29)%></td>
    <td width="106"><%=list.get(30)%></td>
    <td width="106"><%=list.get(31)%></td>
    <td width="106"><%=list.get(32)%></td>
    <td width="106"><%=list.get(33)%></td>
    <td width="106"><%=list.get(34)%></td>
    <td width="106"><%=list.get(35)%></td>
    <td width="106"><%=list.get(36)%></td>
    <td width="106"><%=list.get(37)%></td>
    <td width="106"><%=list.get(38)%></td>
    <td width="106"><%=list.get(39)%></td>
    <td width="106"><%=list.get(40)%></td>
    <td width="124">总数</td>
